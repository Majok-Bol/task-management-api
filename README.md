...
The next version of the project will introduce a database and user system.
...
Each task will belong to a specific user.
...
This will also provide practice with **Broken Object Level Authorization (BOLA/IDOR)** testing.
